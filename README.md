...
AngularGM 1.0.0 is here! This release includes some breaking API changes so make sure to read about it in [MIGRATING](MIGRATING.md)
...
+ [Documentation](http://dylanfprice.github.io/angular-gm/1.0.0/docs/)
+ [Examples](http://dylanfprice.github.io/angular-gm/1.0.0/examples/)
