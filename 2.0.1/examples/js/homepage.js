angular.module('homepage', [])
  ...
  .factory('script', function() {
    ...
    return {
      ...
      angulargm: '<script src="https://dylanfprice.github.io/angular-gm/2.0.1/angular-gm.js"></script>\n',
  ...
  .directive('jsFiddle', function(fetchCode, escape, script) {
    return {
      ...
      link: function(scope, element, attr) {
        var name = '',
            stylesheet = '<link rel="stylesheet" href="http://netdna.bootstrapcdn.com/twitter-bootstrap/2.3.2/css/bootstrap-combined.min.css">\n',
            fields = {
              html: '',
              css: '',
              js: ''
